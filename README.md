...
Assignment from the Odin Project Javascript testing section that requires writing tests for the following functions and making them pass.
...
4. A caesarCipher function that takes a string and returns it with each character “shifted”. Read more about how a Caesar cipher works on this website.
  ...
  2. Don’t forget to test wrapping from z to a.
